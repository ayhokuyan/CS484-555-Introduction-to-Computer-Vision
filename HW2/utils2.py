...
def initialize_parameters_deep(layer_dims):
    ...
    for l in range(1, L):
        ...
        parameters['W' + str(l)] = np.random.randn(layer_dims[l], layer_dims[l-1]
                                                   ) * 0.01  #/ np.sqrt(layer_dims[l-1])  Glorot Uniform
...
def L_model_forward(X, parameters):
    ...
    for l in range(1, L):
        A_prev = A
        # START CODE HERE ### (~2 lines of code)
        A, cache = linear_activation_forward(A_prev, parameters['W{:d}'.format(
            l)], parameters['b{:d}'.format(l)], activation='relu')
        caches.append(cache)
        ### END CODE HERE ###
    ...
    AL, cache = linear_activation_forward(
        A, parameters['W%d' % L], parameters['b%d' % L], activation='sigmoid')
    caches.append(cache)
    ### END CODE HERE ###
